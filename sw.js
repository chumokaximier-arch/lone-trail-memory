const CACHE='lone-trail-memory-v3-ios-portrait';
const ASSETS=['./','./index.html','./manifest.webmanifest','./bg_topo.jpg','./bg_schematic.jpg','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-1024.png','./icons/apple-touch-icon.png','./icons/favicon-32.png'];
